...
const f2 = () => {
    ...
    let out = a2.includes(elem) ? a2.indexOf(elem) : false;
...
const f5 = () => {
    ...
    document.querySelector('.out-5').textContent = a5.includes(elem, index);
}
...
const f8 = () => {
    ...
    document.querySelector('.out-8').textContent = a8.includes(elem)
}
...
const f9 = () => {
    ...
    let out;
    if (isNaN(data)) {
        out = a9.includes(data.toLowerCase()) || a9.includes(data.toUpperCase());
    } else {
        out = a9.includes(+data);
    }
