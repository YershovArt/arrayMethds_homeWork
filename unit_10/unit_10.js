...
const f3 = () => {
    a3_res = [];
    a3_res = a3.map(item => item.reverse());
...
const f7 = () => {
    document.querySelector('.out-7').innerHTML = a7.sort();
}
...
const f8 = () => {
    document.querySelector('.out-8').innerHTML = a7.sort((a, b) => a - b);
}
...
const f9 = (s) => {
    s === 'ASC' ? a9.sort((a, b) => b - a) : s === 'DESC' ? a9.sort((a, b) => a - b) : false;
    return a9;
}
