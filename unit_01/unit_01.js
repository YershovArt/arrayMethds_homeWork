...
const f2 = () => {
    ...
    let out = a2.indexOf(val) !== -1 ? a2.indexOf(val) : false;
...
const f3 = () => {
    ...
    let out = a3.indexOf(val) !== -1 ? true : false;
...
const f5 = () => {
    ...
    let fromIndex = +document.querySelector('.i-5-2').value;
    document.querySelector('.out-5').textContent = a5.indexOf(val, fromIndex);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').textContent = a6.indexOf(elem);
}
...
const f8 = () => {
    // ваш код
    res08 = []
    let elem = +document.querySelector('.i-8').value;
    for (let i = 0; i < a8.length; i++) {
        if (a8.indexOf(elem, i) === i) {
            res08.push(i);
        }
    }
...
const f9 = () => {
    let out = ''
    let elem = +document.querySelector('.i-9').value;
    for (let i = 0; i < a9.length; i++) {
        console.log(a9[i].indexOf(elem));
        if (a9[i].indexOf(elem) !== -1) {
            out += i + ' ';
        } else {
            out += '';
        }
