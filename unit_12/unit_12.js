...
const f6 = () => {
    let res = a6.find(item => {
        if (item < a6_from) {
            return true;
        }
    });
    document.querySelector('.out-6').innerHTML = res ? false : true;
}
...
const f10 = () => {
    document.querySelector('.out-10').innerHTML = a10.some(isBigFrom);
}
