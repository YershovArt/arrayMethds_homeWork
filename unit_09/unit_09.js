...
const f2 = () => {
	...
	document.querySelector('.out-2').textContent = res || false;
}
...
const f6 = () => {
	...
	let res = reversedArray.findIndex(item => {
		if (item > a6_from && a6_to > item) {
			return true
		}
	});
	document.querySelector('.out-6').innerHTML = res || false;
}
...
const f7 = () => {
	document.querySelector('.out-7').innerHTML = str7.lastIndexOf(a7_1);
}
...
const f8 = () => {
	let loweredString = str8.toLowerCase();
	document.querySelector('.out-8').innerHTML = loweredString.lastIndexOf(a8_1);
}
...
const f9 = () => {
	document.querySelector('.out-9').innerHTML = a9.lastIndexOf(a9_1);
}
